...
/**
 * GeoGebra application inside a JPanel that can be integrated into other
 * applications.
 */
public class GeoGebraPanel extends JPanel {
	...
	/**
	 * Creates a GeoGebraPanel and loads the given ggbFile. Note that you need
	 * to call buildGUI() after this method.
	 */
	...
	/**
	 * Loads a ggb or ggt file. Note that you need to call buildGUI() after this
	...
	/**
	 * Tells the panel to show/hide the tool bar. Note that you need to call
	 * buildGUI() after this method to update the panel's structure.
	 */
	...
	/**
	 * Tells the panel to show/hide the menu bar. Note that you need to call
	 * buildGUI() after this method to update the panel's structure.
	 */
	...
	/**
	 * Tells the panel to show/hide the input bar. Note that you need to call
	 * buildGUI() after this method to update the panel's structure.
	 */
	...
	/**
	 * Tells the panel to show/hide the algebra view. Note that you need to call
	 * buildGUI() after this method to update the panel's structure.
	 */
	...
	/**
	 * Tells the panel to show/hide the spreadsheet view. Note that you need to
	 * call buildGUI() after this method to update the panel's structure.
	 */
	...
	/**
	 * Sets the language of the GeoGebraPanel. Note that you need to call
	 * buildGUI() after this method to update the panel's structure.
	 */
